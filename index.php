...
if ($result1 > $result2) {
    echo "Результат выражения '125 умножить на 13 плюс 7' больше, чем результат выражения '223 плюс 28 умножить на 2' <br/>";
} elseif ($result1 < $result2) {
    echo "Результат выражения '223 плюс 28 умножить на 2' больше, чем результат выражения '125 умножить на 13 плюс 7' <br/>";
} else {
    echo "Результаты выражений равны <br/>";
}


 echo "Тест     для проверки branch"
